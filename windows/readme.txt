This is UMoria 5.6, compiled for 32-bit Windows using Microsoft Visual Studio 2013 + PDCurses.
...
I was recently inspired to produce a modern Windows port of UMoria 5.6 using Cygwin, but decided to also attempt this port of UMoria 5.6 using Microsoft Visual Studio 2013. This port is intended to provide an experience closer to that of the old MS-DOS ports.
